...
class ParlerTTSConfig(PretrainedConfig):
    ...
    Args:
        ...
        use_precomputed_vectors (`bool`, *optional*, defaults to `False`):
            Whether to use precomputed vectors instead of processing text descriptions through the text encoder at runtime.
        precomputed_vector_dim (`int`, *optional*, defaults to 1024):
            Dimensionality of the precomputed vectors. Should match the text encoder's hidden size.
        num_precomputed_vectors (`int`, *optional*, defaults to 64):
            Number of precomputed vectors to use.
        attribute_vector_indices (`List[int]`, *optional*, defaults to None):
            Indices of vectors that represent style attributes (gender, pitch, accent, etc.) for VAE processing.
        lora_rank (`int`, *optional*, defaults to 16):
            Rank for LoRA adapters applied to precomputed vectors.
        lora_alpha (`float`, *optional*, defaults to 32.0):
            Scaling parameter for LoRA adapters.
        vae_latent_dim (`int`, *optional*, defaults to 128):
            Latent dimension for VAE modules applied to attribute vectors.
        orthogonal_reg_strength (`float`, *optional*, defaults to 0.01):
            Strength of orthogonality regularization to keep enhanced vectors distinct.
        kwargs (*optional*):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.use_precomputed_vectors = use_precomputed_vectors
        self.precomputed_vector_dim = precomputed_vector_dim
        self.num_precomputed_vectors = num_precomputed_vectors
        self.attribute_vector_indices = attribute_vector_indices or []
        self.lora_rank = lora_rank
        self.lora_alpha = lora_alpha
        self.vae_latent_dim = vae_latent_dim
        self.orthogonal_reg_strength = orthogonal_reg_strength
        
        # Attribute values for token-level VAE assignment
